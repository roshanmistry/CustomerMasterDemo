                ...
                <CardContent>
                    ...
                    <div className="row">
                        <div className="left_view col-lg-6 col-md-6 col-12">
                            ...
                            <h3 className="mt-3">Client Name: <span >{getuserdata.customer_name}</span></h3>
                        ...
                        <div className="right_view  col-lg-6 col-md-6 col-12">
                            ...
                            <p className="mt-3"><LocationOnIcon />country: <span>{getuserdata.country}</span></p>
                            <p className="mt-3"><LocationOnIcon />state: <span>{getuserdata.state}</span></p>
                            <p className="mt-3"><LocationOnIcon />city: <span>{getuserdata.city}</span></p>
                        </div>
                    </div>
